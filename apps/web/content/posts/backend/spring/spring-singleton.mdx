---
title: "Spring Singleton - 싱글톤 디자인 패턴과 주의점"
description: "웹 애플리케이션에서 싱글톤 패턴의 필요성과 스프링 컨테이너의 싱글톤 관리 방식"
date: 2024-03-10
categories: ["spring"]
tags: ["Spring", "Java", "Singleton", "Design Pattern"]
author: "Carefreelife98"
thumbnail: "/images/Spring/SpringBasic/spring_singleton_1.png"
published: true
---
...
> **하지만 스프링 프레임워크는 앞서 제시한 모든 단점을 커버하는 싱글톤 컨테이너(스프링 컨테이너)를 제공한다.**

# 싱글톤 컨테이너 (스프링 컨테이너)

![스프링 컨테이너의 싱글톤 관리](/images/Spring/SpringBasic/spring_singleton_1.png)
...
public class StatelessService {
    ...
    public int order(String name, int price) {
        System.out.println("name = " + name + " price = " + price);
        return price;  // 로직 수행 후 상태를 가지고 있지 않고 반환
    }
}
```
